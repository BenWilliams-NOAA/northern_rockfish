...
Gulfwide discard rates (% discarded) for northern rockfish in the commercial fishery for 1993-2020 are as follows:

```{r}

data.frame(Year = 1993:2018, 
           discard = c(26.5,17.7,12.7,16.6,28.0,18.4,11.3,10.0,17.7,10.0,9.4,
                       7.9,4.3,9.2,2.6,4.9,3.1,1.5,3.9,2.5,4.2,3.9,4.6,5.7,8.0,1.7)) -> dat
...
dat %>% 
  ...
  flextable::colformat_num(i=1, big.mark = "", decimal.mark = "") %>% 
  flextable::delete_part() %>% 
  flextable::compose(i=2, j=1,
            value = flextable::as_paragraph( "% Discarded"),
            part = "body") %>% 
